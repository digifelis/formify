    ...
    <div class="col-md-8">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" wire:model="name" name="name" value="{{$form->name}}" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" wire:model="save_data" name="save_data" value="1" @if($form->save_data) checked @endif>

            </div>
            <div class="form-group">
                <label for="display_name">Display Name</label>
                <input type="text" class="form-control" id="display_name" wire:model="display_name" name="display_name" value="{{$form->display_name}}" >
            </div>
